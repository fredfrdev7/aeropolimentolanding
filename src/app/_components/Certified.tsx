        ...
        <section className="bg-linear-to-tr from-zinc-100 via-white via-50% to-zinc-300 to-160% p-4 pt-12 pb-9 overflow-hidden">
            <div className="lg:flex gap-20">
                <div className="">
                    ...
                    <p className="pb-6 pt-4 font-custom font-light" data-aos="fade-right">A primeira empresa especializada em estética aeronaútica homologada para executar serviços de limpeza e conservação de aeronaves, atendendo em todo território nacional e internacional, conforme orientação dos manuais de fabricantes e regulamentações da ANAC.</p>
                </div>
